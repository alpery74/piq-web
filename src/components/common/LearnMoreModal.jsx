    ...
    <div className="p-6">
        ...
        <div className="mb-6 p-4 bg-ios-blue/5 rounded-xl border border-ios-blue/20">
          ...
          <div className="flex gap-2 mt-3">
            <button
              ...
              className="px-4 py-2 text-sm font-medium rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              Previous
            </button>
            <button
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {Object.entries(term.range).map(([key, val]) => (
              ...
              >
                ...
                <div className="text-sm text-gray-600 dark:text-gray-400 mt-1">{val.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="mt-6 p-4 bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 rounded-xl">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h4 className="font-semibold text-green-900 dark:text-green-200">Pro Tip</h4>
        </div>
