    ...
    <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center bg-gray-900/50 backdrop-blur-sm">
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 bg-gray-50 dark:bg-gray-900">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                ...
                <button
                  onClick={() => selectRunAndClose(lastRunId)}
                  disabled={!lastRunId}
                  className="flex flex-col items-center gap-3 p-5 rounded-xl bg-blue-50 border-2 border-blue-200 hover:border-blue-400 hover:bg-blue-100 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-sm hover:shadow-md group"
                >
                  ...
                  <div className="text-center">
                    <p className="text-sm font-semibold text-gray-800">Continue</p>
                    <p className="text-xs text-blue-600 truncate max-w-[80px]">
                      {lastRunId ? 'Last run' : 'No history'}
                    </p>
                  </div>
                </button>
                ...
                <button
                  onClick={handleNewPortfolio}
                  className="flex flex-col items-center gap-3 p-5 rounded-xl bg-gradient-to-br from-indigo-50 to-purple-50 border-2 border-indigo-200 hover:border-indigo-400 hover:from-indigo-100 hover:to-purple-100 transition-all shadow-sm hover:shadow-md group"
                >
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xs text-indigo-600">Portfolio</p>
                  </div>
                </button>
                ...
                <button
                  onClick={handleQuickDemo}
                  disabled={startingDemo}
                  className="flex flex-col items-center gap-3 p-5 rounded-xl bg-green-50 border-2 border-green-200 hover:border-green-400 hover:bg-green-100 transition-all disabled:opacity-50 shadow-sm hover:shadow-md group"
                >
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xs text-green-600">Sample data</p>
                  </div>
                </button>
              </div>
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <span className="text-xs text-gray-400">{portfolios.length} total</span>
              </div>
                ...
                {showAdvanced && (
                  <div className="mt-3 flex gap-2">
                    <input
                      ...
                      onChange={(e) => setRunIdInput(e.target.value)}
                      placeholder="Enter run ID..."
                      className="flex-1 px-3 py-2 text-sm rounded-lg border border-gray-200 bg-white/60 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-primary-300"
                    />
                    <button
                      onClick={handleLoadRunId}
                      disabled={!runIdInput.trim()}
          ...
          {/* Error display */}
          {error && (
            <div className="mt-4 rounded-xl bg-red-50 border border-red-200/50 text-red-700 px-4 py-3 text-sm">
              {error}
            </div>
          )}
        </div>
