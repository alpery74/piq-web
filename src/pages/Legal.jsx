const Legal = () => {
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">About & Legal</h1>

      <div className="space-y-8">
        <section className="card">
          <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">About PIQ Labs</h2>
        ...
        <section className="card">
          <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Disclaimer: Not Financial Advice</h2>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <section className="card">
          <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Terms of Use</h2>
        ...
        <section className="card">
          <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Subscription Terms & Billing</h2>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
        ...
        <section className="card">
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <a href="/privacy" className="text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300 font-medium">Privacy Policy</a>.
          </p>
        </section>
      </div>
    </div>
